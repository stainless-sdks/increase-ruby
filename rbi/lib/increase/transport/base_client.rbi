...
module Increase
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[Increase::Type::BasePage[Increase::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(Increase::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: Increase::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: Increase::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(Increase::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(Increase::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(req: Increase::Transport::BaseClient::RequestComponentsShape, opts: Increase::Util::AnyHash)
          .returns(Increase::Transport::BaseClient::RequestInputShape)
      end
