...
module Increase
  module Type
    # @api private
    module Converter
      Input = T.type_alias { T.any(Increase::Type::Converter, T::Class[T.anything]) }
      ...
      # @api private
      sig do
        overridable.params(value: T.anything, state: Increase::Type::Converter::State).returns(T.anything)
      end
      ...
      class << self
            ...
            spec: T.any(
              {
                ...
                enum: T.nilable(T.proc.returns(Increase::Type::Converter::Input)),
                union: T.nilable(T.proc.returns(Increase::Type::Converter::Input))
              },
        ...
        sig do
          params(
            target: Increase::Type::Converter::Input,
            value: T.anything,
        ...
        # @api private
        sig { params(target: Increase::Type::Converter::Input, value: T.anything).returns(T.anything) }
