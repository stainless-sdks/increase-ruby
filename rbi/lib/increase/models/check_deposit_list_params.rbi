...
module Increase
  module Models
    class CheckDepositListParams < Increase::BaseModel
      ...
      sig do
        params(_: Increase::Models::CheckDepositListParams::CreatedAt).returns(Increase::Models::CheckDepositListParams::CreatedAt)
      end
      def created_at=(_)
      end
