    ...
    class Transaction < Increase::BaseModel
      ...
      class Source < Increase::BaseModel
        ...
        class AccountTransferIntention < Increase::BaseModel
          ...
          def initialize(amount:, currency:, description:, destination_account_id:, source_account_id:, transfer_id:)
          end
        ...
        class ACHTransferReturn < Increase::BaseModel
          ...
          def initialize(created_at:, raw_return_reason_code:, return_reason_code:, trace_number:, transaction_id:, transfer_id:)
          end
            ...
            class Travel < Increase::BaseModel
              ...
              class Ancillary < Increase::BaseModel
                ...
                class CreditReasonIndicator < Increase::Enum
                  ...
                  PASSENGER_TRANSPORT_ANCILLARY_PURCHASE_CANCELLATION = T.let(:passenger_transport_ancillary_purchase_cancellation, T.nilable(Symbol))

                  # Airline ticket and passenger transport ancillary purchase cancellation
                  AIRLINE_TICKET_AND_PASSENGER_TRANSPORT_ANCILLARY_PURCHASE_CANCELLATION = T.let(:airline_ticket_and_passenger_transport_ancillary_purchase_cancellation, T.nilable(Symbol))
        ...
        class CashbackPayment < Increase::BaseModel
          ...
          sig do
            override
              .returns(
                {accrued_on_card_id: T.nilable(String), amount: Integer, currency: Symbol, period_end: Time, period_start: Time}
              )
          end
          def to_hash
          end
        ...
        class FeePayment < Increase::BaseModel
          ...
          sig { params(amount: Integer, currency: Symbol, fee_period_start: Date, program_id: T.nilable(String)).void }
          def initialize(amount:, currency:, fee_period_start:, program_id:)
          end

          sig do
            override
              .returns({amount: Integer, currency: Symbol, fee_period_start: Date, program_id: T.nilable(String)})
          end
          def to_hash
          end
        ...
        class InterestPayment < Increase::BaseModel
          ...
          sig do
            override
              .returns(
                {accrued_on_account_id: String, amount: Integer, currency: Symbol, period_end: Time, period_start: Time}
              )
          end
          def to_hash
          end
        ...
        class RealTimePaymentsTransferAcknowledgement < Increase::BaseModel
          ...
          def initialize(amount:, destination_account_number:, destination_routing_number:, remittance_information:, transfer_id:)
          end
