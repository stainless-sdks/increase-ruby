  ...
  module Models
    class FileListParams < Increase::BaseModel
      ...
      class Purpose < Increase::BaseModel
        ...
        sig do
          params(_: T::Array[Increase::Models::FileListParams::Purpose::In::OrSymbol])
            .returns(T::Array[Increase::Models::FileListParams::Purpose::In::OrSymbol])
        end
        def in_=(_)
        end
        ...
        module In
          ...
          CHECK_IMAGE_FRONT = T.let(:check_image_front, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # An image of the back of a check, used for check deposits.
          CHECK_IMAGE_BACK = T.let(:check_image_back, Increase::Models::FileListParams::Purpose::In::OrSymbol)
          ...
          PROCESSED_CHECK_IMAGE_FRONT =
            T.let(:processed_check_image_front, Increase::Models::FileListParams::Purpose::In::OrSymbol)
          ...
          PROCESSED_CHECK_IMAGE_BACK =
            T.let(:processed_check_image_back, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # An image of a check that was mailed to a recipient.
          MAILED_CHECK_IMAGE = T.let(:mailed_check_image, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # An image to be printed on the bottom or voucher of a check that you've requested Increase print.
          CHECK_VOUCHER_IMAGE =
            T.let(:check_voucher_image, Increase::Models::FileListParams::Purpose::In::OrSymbol)
          ...
          CHECK_ATTACHMENT_IMAGE =
            T.let(:check_attachment_image, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A scanned mail item sent to Increase.
          INBOUND_MAIL_ITEM = T.let(:inbound_mail_item, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # IRS Form 1099-INT.
          FORM_1099_INT = T.let(:form_1099_int, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # IRS Form 1099-MISC.
          FORM_1099_MISC = T.let(:form_1099_misc, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # IRS Form SS-4.
          FORM_SS_4 = T.let(:form_ss_4, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # An image of a government-issued ID.
          IDENTITY_DOCUMENT = T.let(:identity_document, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A statement generated by Increase.
          INCREASE_STATEMENT = T.let(:increase_statement, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A file purpose not covered by any of the other cases.
          OTHER = T.let(:other, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A legal document forming a trust.
          TRUST_FORMATION_DOCUMENT =
            T.let(:trust_formation_document, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A card image to be rendered inside digital wallet apps. This must be a 1536x969 pixel PNG.
          DIGITAL_WALLET_ARTWORK =
            T.let(:digital_wallet_artwork, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # An icon for you app to be rendered inside digital wallet apps. This must be a 100x100 pixel PNG.
          DIGITAL_WALLET_APP_ICON =
            T.let(:digital_wallet_app_icon, Increase::Models::FileListParams::Purpose::In::OrSymbol)
          ...
          PHYSICAL_CARD_FRONT =
            T.let(:physical_card_front, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # The image to be printed on the back of a physical card.
          PHYSICAL_CARD_BACK = T.let(:physical_card_back, Increase::Models::FileListParams::Purpose::In::OrSymbol)
          ...
          PHYSICAL_CARD_CARRIER =
            T.let(:physical_card_carrier, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A document requested by Increase.
          DOCUMENT_REQUEST = T.let(:document_request, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A supplemental document associated an an Entity.
          ENTITY_SUPPLEMENTAL_DOCUMENT =
            T.let(:entity_supplemental_document, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # The results of an Export you requested via the dashboard or API.
          EXPORT = T.let(:export, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # An attachment to an Unusual Activity Report.
          UNUSUAL_ACTIVITY_REPORT_ATTACHMENT =
            T.let(:unusual_activity_report_attachment, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A document granting another entity access to the funds into your account.
          DEPOSIT_ACCOUNT_CONTROL_AGREEMENT =
            T.let(:deposit_account_control_agreement, Increase::Models::FileListParams::Purpose::In::OrSymbol)

          # A file containing additional evidence for a Proof of Authorization Request Submission.
          PROOF_OF_AUTHORIZATION_REQUEST_SUBMISSION =
            T.let(:proof_of_authorization_request_submission, Increase::Models::FileListParams::Purpose::In::OrSymbol)
        end
      end
    end
  end
