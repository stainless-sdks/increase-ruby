    ...
    module Simulations
      class ACHTransferReturnParams < Increase::BaseModel
        ...
        module Reason
          ...
          INSUFFICIENT_FUND =
            T.let(:insufficient_fund, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)

          # Code R03. The account does not exist or the receiving bank was unable to locate it.
          NO_ACCOUNT = T.let(:no_account, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)

          # Code R02. The account is closed at the receiving bank.
          ACCOUNT_CLOSED =
            T.let(:account_closed, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          PAYMENT_STOPPED =
            T.let(:payment_stopped, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)

          # Code R20. The receiving bank account does not perform transfers.
          NON_TRANSACTION_ACCOUNT =
            T.let(:non_transaction_account, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)

          # Code R09. The receiving bank account does not have enough available balance for the transfer.
          UNCOLLECTED_FUNDS =
            T.let(:uncollected_funds, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          AMOUNT_FIELD_ERROR =
            T.let(:amount_field_error, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          ADDENDA_ERROR =
            T.let(:addenda_error, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          CORRECTED_RETURN =
            T.let(:corrected_return, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)

          # Code R24. A rare return reason. The receiving bank received an exact duplicate entry with the same trace number and amount.
          DUPLICATE_ENTRY =
            T.let(:duplicate_entry, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)

          # Code R67. A rare return reason. The return this message refers to was a duplicate.
          DUPLICATE_RETURN =
            T.let(:duplicate_return, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)

          # Code R47. A rare return reason. Only used for US Government agency non-monetary automatic enrollment messages.
          ENR_DUPLICATE_ENROLLMENT =
            T.let(:enr_duplicate_enrollment, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          ENR_RETURN_OF_ENR_ENTRY =
            T.let(:enr_return_of_enr_entry, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          FIELD_ERROR =
            T.let(:field_error, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          IAT_ENTRY_CODING_ERROR =
            T.let(:iat_entry_coding_error, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          INVALID_COMPANY_ID =
            T.let(:invalid_company_id, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          MANDATORY_FIELD_ERROR =
            T.let(:mandatory_field_error, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          MISROUTED_RETURN =
            T.let(:misrouted_return, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          NO_ERRORS_FOUND =
            T.let(:no_errors_found, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          PERMISSIBLE_RETURN_ENTRY =
            T.let(:permissible_return_entry, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          RDFI_NON_SETTLEMENT =
            T.let(:rdfi_non_settlement, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          RETURN_NOT_A_DUPLICATE =
            T.let(:return_not_a_duplicate, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          RETURN_OF_XCK_ENTRY =
            T.let(:return_of_xck_entry, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          TIMELY_ORIGINAL_RETURN =
            T.let(:timely_original_return, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)

          # Code R27. A rare return reason. An ACH return's trace number does not match an originated ACH.
          TRACE_NUMBER_ERROR =
            T.let(:trace_number_error, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
          ...
          UNTIMELY_RETURN =
            T.let(:untimely_return, Increase::Models::Simulations::ACHTransferReturnParams::Reason::OrSymbol)
        end
      end
    end
  end
