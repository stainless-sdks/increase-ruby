...
module Increase
  module Models
    class InboundRealTimePaymentsTransferListParams < Increase::BaseModel
      ...
      sig do
        params(_: Increase::Models::InboundRealTimePaymentsTransferListParams::CreatedAt).returns(Increase::Models::InboundRealTimePaymentsTransferListParams::CreatedAt)
      end
      def created_at=(_)
      end
