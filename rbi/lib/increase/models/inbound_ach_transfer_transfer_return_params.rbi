  ...
  module Models
    class InboundACHTransferTransferReturnParams < Increase::BaseModel
      ...
      module Reason
        ...
        INSUFFICIENT_FUNDS =
          T.let(:insufficient_funds, Increase::Models::InboundACHTransferTransferReturnParams::Reason::OrSymbol)
        ...
        PAYMENT_STOPPED =
          T.let(:payment_stopped, Increase::Models::InboundACHTransferTransferReturnParams::Reason::OrSymbol)
        ...
        DUPLICATE_ENTRY =
          T.let(:duplicate_entry, Increase::Models::InboundACHTransferTransferReturnParams::Reason::OrSymbol)
