  ...
  module Models
    class InboundACHTransferDeclineParams < Increase::BaseModel
      ...
      module Reason
        ...
        INSUFFICIENT_FUNDS =
          T.let(:insufficient_funds, Increase::Models::InboundACHTransferDeclineParams::Reason::OrSymbol)
        ...
        RETURNED_PER_ODFI_REQUEST =
          T.let(:returned_per_odfi_request, Increase::Models::InboundACHTransferDeclineParams::Reason::OrSymbol)
        ...
        PAYMENT_STOPPED =
          T.let(:payment_stopped, Increase::Models::InboundACHTransferDeclineParams::Reason::OrSymbol)
        ...
        DUPLICATE_ENTRY =
          T.let(:duplicate_entry, Increase::Models::InboundACHTransferDeclineParams::Reason::OrSymbol)
