...
module Increase
  module Models
    class File < Increase::Internal::Type::BaseModel
      # #/components/schemas/file/properties/id
      sig { returns(String) }
      attr_accessor :id

      # #/components/schemas/file/properties/created_at
      sig { returns(Time) }
      attr_accessor :created_at

      # #/components/schemas/file/properties/description
      sig { returns(T.nilable(String)) }
      attr_accessor :description

      # #/components/schemas/file/properties/direction
      sig { returns(Increase::Models::File::Direction::TaggedSymbol) }
      attr_accessor :direction

      # #/components/schemas/file/properties/filename
      sig { returns(T.nilable(String)) }
      attr_accessor :filename

      # #/components/schemas/file/properties/idempotency_key
      sig { returns(T.nilable(String)) }
      attr_accessor :idempotency_key

      # #/components/schemas/file/properties/mime_type
      sig { returns(String) }
      attr_accessor :mime_type

      # #/components/schemas/file/properties/purpose
      sig { returns(Increase::Models::File::Purpose::TaggedSymbol) }
      attr_accessor :purpose

      # #/components/schemas/file/properties/type
