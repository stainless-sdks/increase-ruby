...
module Increase
  module Models
    class RealTimePaymentsRequestForPaymentListParams < Increase::BaseModel
      ...
      sig do
        params(_: Increase::Models::RealTimePaymentsRequestForPaymentListParams::CreatedAt)
          .returns(Increase::Models::RealTimePaymentsRequestForPaymentListParams::CreatedAt)
      end
      def created_at=(_)
      end
