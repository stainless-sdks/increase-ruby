...
module Increase
  ...
  module Converter
    ...
    # @api private
    sig { overridable.params(value: T.anything, state: Increase::Converter::State).returns(T.anything) }
    ...
    class << self
      ...
      sig do
        params(target: Increase::Converter::Input, value: T.anything, state: Increase::Converter::State)
          .returns(T.anything)
      end
      def self.coerce(
        target,
  ...
  class Unknown
    ...
    class << self
      # @api private
      sig(:final) do
        override.params(value: T.anything, state: Increase::Converter::State).returns(T.anything)
      end
      def coerce(value, state:)
      end
  ...
  class BooleanModel
    ...
    class << self
      ...
      sig(:final) do
        override
          .params(value: T.any(T::Boolean, T.anything), state: Increase::Converter::State)
  ...
  module Enum
    ...
    sig do
      override
        .params(value: T.any(String, Symbol, T.anything), state: Increase::Converter::State)
  ...
  module Union
    ...
    sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Increase::Converter::Input)]]) }
    ...
    sig do
      params(
        key: T.any(Symbol, Increase::Util::AnyHash, T.proc.returns(T.anything), T.anything),
        spec: T.any(Increase::Util::AnyHash, T.proc.returns(T.anything), T.anything)
      )
        .void
    end
    ...
    # @api private
    sig { override.params(value: T.anything, state: Increase::Converter::State).returns(T.anything) }
    def coerce(value, state:)
    end
  ...
  class ArrayOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Enumerable[T.anything], T.anything), state: Increase::Converter::State)
  ...
  class HashOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Hash[T.anything, T.anything], T.anything), state: Increase::Converter::State)
  ...
  class BaseModel
    ...
    sig { overridable.returns(Increase::Util::AnyHash) }
    def to_h
    end
    ...
    sig { params(keys: T.nilable(T::Array[Symbol])).returns(Increase::Util::AnyHash) }
