...
module Increase
  module Internal
    ...
    module Util
      ...
      #   structure when using `Increase::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(Increase::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(Increase::Internal::Util::ParsedUriShape) }
        def parse_uri(url)
        end

        # @api private
        sig { params(parsed: Increase::Internal::Util::ParsedUriShape).returns(URI::Generic) }
        def unparse_uri(parsed)
        end

        # @api private
        sig do
          params(lhs: Increase::Internal::Util::ParsedUriShape, rhs: Increase::Internal::Util::ParsedUriShape)
            .returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(Increase::Internal::Util::ServerSentEvent) }
