...
module Increase
  module Resources
    class Entities
      ...
      # Retrieve an Entity
      sig { params(entity_id: String, request_options: Increase::RequestOptions::OrHash).returns(Increase::Entity) }
      def retrieve(
      ...
      sig do
        params(entity_id: String, beneficial_owner_id: String, request_options: Increase::RequestOptions::OrHash)
          .returns(Increase::Entity)
      end
      ...
      sig do
        params(entity_id: String, confirmed_at: Time, request_options: Increase::RequestOptions::OrHash)
          .returns(Increase::Entity)
      end
      def confirm(
      ...
      sig do
        params(entity_id: String, industry_code: String, request_options: Increase::RequestOptions::OrHash)
          .returns(Increase::Entity)
      end
