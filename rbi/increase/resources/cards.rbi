...
module Increase
  module Resources
    class Cards
      ...
      # Retrieve a Card
      sig { params(card_id: String, request_options: Increase::RequestOptions::OrHash).returns(Increase::Card) }
      def retrieve(
      ...
      sig { params(card_id: String, request_options: Increase::RequestOptions::OrHash).returns(Increase::CardDetails) }
      def details(
