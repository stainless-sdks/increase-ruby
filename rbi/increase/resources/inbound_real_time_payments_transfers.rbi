...
module Increase
  module Resources
    class InboundRealTimePaymentsTransfers
      ...
      sig do
        params(inbound_real_time_payments_transfer_id: String, request_options: Increase::RequestOptions::OrHash)
      ...
      sig do
        params(
          ...
          .returns(Increase::Internal::Page[Increase::InboundRealTimePaymentsTransfer])
      end
      def list(
