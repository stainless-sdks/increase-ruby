...
module Increase
  module Resources
    class InboundWireDrawdownRequests
      ...
      sig do
        params(inbound_wire_drawdown_request_id: String, request_options: Increase::RequestOptions::OrHash)
      ...
      sig do
        params(cursor: String, limit: Integer, request_options: Increase::RequestOptions::OrHash)
          .returns(Increase::Internal::Page[Increase::InboundWireDrawdownRequest])
      end
      def list(
