...
module Increase
  module Resources
    class BookkeepingAccounts
      ...
      sig do
        params(bookkeeping_account_id: String, name: String, request_options: Increase::RequestOptions::OrHash)
          .returns(Increase::BookkeepingAccount)
      end
      def update(
      ...
      sig do
        params(bookkeeping_account_id: String, at_time: Time, request_options: Increase::RequestOptions::OrHash)
