...
module Increase
  module Resources
    class Accounts
      ...
      # Retrieve an Account
      sig { params(account_id: String, request_options: Increase::RequestOptions::OrHash).returns(Increase::Account) }
      def retrieve(
      ...
      # Update an Account
      sig do
        params(account_id: String, name: String, request_options: Increase::RequestOptions::OrHash)
          .returns(Increase::Account)
      end
      def update(
      ...
      sig do
        params(account_id: String, at_time: Time, request_options: Increase::RequestOptions::OrHash)
