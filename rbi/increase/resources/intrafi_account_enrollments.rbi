...
module Increase
  module Resources
    class IntrafiAccountEnrollments
      ...
      sig do
        params(account_id: String, email_address: String, request_options: Increase::RequestOptions::OrHash)
      ...
      sig do
        params(intrafi_account_enrollment_id: String, request_options: Increase::RequestOptions::OrHash)
          .returns(Increase::IntrafiAccountEnrollment)
      end
      def retrieve(
