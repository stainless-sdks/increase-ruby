  ...
  module Internal
    module Transport
      ...
      class PooledNetRequester
        ...
        # @api private
        sig do
          params(request: Increase::Internal::Transport::PooledNetRequester::Request)
        ...
        def self.new(size: Increase::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS); end
      end
    end
  end
end
