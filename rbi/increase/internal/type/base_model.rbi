  ...
  module Internal
    module Type
      class BaseModel
        ...
        OrHash = T.type_alias { T.any(Increase::Internal::Type::BaseModel, Increase::Internal::AnyHash) }
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(Increase::Internal::Type::BaseModel::KnownField, {type_fn: T.proc.returns(Increase::Internal::Type::Converter::Input)})
              ]
            )
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(Increase::Internal::Type::BaseModel::KnownField, {type: Increase::Internal::Type::Converter::Input})
              ]
            )
          end
          def fields; end
              ...
              type_info: T.any(
                {
                  ...
                  enum: T.nilable(T.proc.returns(Increase::Internal::Type::Converter::Input)),
                  union: T.nilable(T.proc.returns(Increase::Internal::Type::Converter::Input)),
                  api_name: Symbol,
                  "nil?": T::Boolean
                },
        ...
        class << self
          ...
          sig do
            override
              .params(
                value: T.any(Increase::Internal::Type::BaseModel, T::Hash[T.anything, T.anything], T.anything),
          ...
          sig do
            override
              .params(value: T.any(T.attached_class, T.anything), state: Increase::Internal::Type::Converter::DumpState)
        ...
        class << self
          # @api private
          sig do
            params(model: Increase::Internal::Type::BaseModel, convert: T::Boolean)
