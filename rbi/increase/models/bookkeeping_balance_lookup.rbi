...
module Increase
  module Models
    class BookkeepingBalanceLookup < Increase::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Increase::BookkeepingBalanceLookup, Increase::Internal::AnyHash) }
      ...
      sig do
        override
          .returns(
            {balance: Integer, bookkeeping_account_id: String, type: Increase::BookkeepingBalanceLookup::Type::TaggedSymbol}
          )
      end
      def to_hash; end
      ...
      module Type
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::BookkeepingBalanceLookup::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        BOOKKEEPING_BALANCE_LOOKUP =
          T.let(:bookkeeping_balance_lookup, Increase::BookkeepingBalanceLookup::Type::TaggedSymbol)

        sig { override.returns(T::Array[Increase::BookkeepingBalanceLookup::Type::TaggedSymbol]) }
        def self.values; end
      end
    end
  end
