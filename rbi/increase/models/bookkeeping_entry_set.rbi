...
module Increase
  module Models
    class BookkeepingEntrySet < Increase::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Increase::BookkeepingEntrySet, Increase::Internal::AnyHash) }
      ...
      class Entry < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::BookkeepingEntrySet::Entry, Increase::Internal::AnyHash) }
      ...
      module Type
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::BookkeepingEntrySet::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        BOOKKEEPING_ENTRY_SET = T.let(:bookkeeping_entry_set, Increase::BookkeepingEntrySet::Type::TaggedSymbol)

        sig { override.returns(T::Array[Increase::BookkeepingEntrySet::Type::TaggedSymbol]) }
        def self.values; end
      end
    end
  end
