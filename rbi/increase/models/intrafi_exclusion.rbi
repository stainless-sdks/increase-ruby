...
module Increase
  module Models
    class IntrafiExclusion < Increase::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Increase::IntrafiExclusion, Increase::Internal::AnyHash) }
      ...
      module Status
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::IntrafiExclusion::Status) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        # The exclusion is being added to the IntraFi network.
        PENDING = T.let(:pending, Increase::IntrafiExclusion::Status::TaggedSymbol)

        # The exclusion has been added to the IntraFi network.
        COMPLETED = T.let(:completed, Increase::IntrafiExclusion::Status::TaggedSymbol)

        # The exclusion has been removed from the IntraFi network.
        ARCHIVED = T.let(:archived, Increase::IntrafiExclusion::Status::TaggedSymbol)

        sig { override.returns(T::Array[Increase::IntrafiExclusion::Status::TaggedSymbol]) }
        def self.values; end
      end
      ...
      module Type
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::IntrafiExclusion::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        INTRAFI_EXCLUSION = T.let(:intrafi_exclusion, Increase::IntrafiExclusion::Type::TaggedSymbol)

        sig { override.returns(T::Array[Increase::IntrafiExclusion::Type::TaggedSymbol]) }
        def self.values; end
      end
    end
  end
