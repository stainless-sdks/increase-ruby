...
module Increase
  module Models
    class WireTransfer < Increase::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Increase::WireTransfer, Increase::Internal::AnyHash) }
      ...
      sig { params(approval: T.nilable(Increase::WireTransfer::Approval::OrHash)).void }
      ...
      sig { params(cancellation: T.nilable(Increase::WireTransfer::Cancellation::OrHash)).void }
      ...
      sig { params(created_by: T.nilable(Increase::WireTransfer::CreatedBy::OrHash)).void }
      ...
      sig { params(reversal: T.nilable(Increase::WireTransfer::Reversal::OrHash)).void }
      ...
      sig { params(submission: T.nilable(Increase::WireTransfer::Submission::OrHash)).void }
      ...
      class Approval < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::WireTransfer::Approval, Increase::Internal::AnyHash) }
      ...
      class Cancellation < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::WireTransfer::Cancellation, Increase::Internal::AnyHash) }
      ...
      class CreatedBy < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::WireTransfer::CreatedBy, Increase::Internal::AnyHash) }

        # If present, details about the API key that created the transfer.
        sig { returns(T.nilable(Increase::WireTransfer::CreatedBy::APIKey)) }
        attr_reader :api_key

        sig { params(api_key: T.nilable(Increase::WireTransfer::CreatedBy::APIKey::OrHash)).void }
        attr_writer :api_key

        # The type of object that created this transfer.
        sig { returns(Increase::WireTransfer::CreatedBy::Category::TaggedSymbol) }
        attr_accessor :category

        # If present, details about the OAuth Application that created the transfer.
        sig { returns(T.nilable(Increase::WireTransfer::CreatedBy::OAuthApplication)) }
        attr_reader :oauth_application

        sig { params(oauth_application: T.nilable(Increase::WireTransfer::CreatedBy::OAuthApplication::OrHash)).void }
        ...
        sig { params(user: T.nilable(Increase::WireTransfer::CreatedBy::User::OrHash)).void }
        attr_writer :user

        # What object created the transfer, either via the API or the dashboard.
        sig do
          params(
            api_key: T.nilable(Increase::WireTransfer::CreatedBy::APIKey::OrHash),
            ...
            .returns(
              {
                ...
                category: Increase::WireTransfer::CreatedBy::Category::TaggedSymbol,
                oauth_application: T.nilable(Increase::WireTransfer::CreatedBy::OAuthApplication),
        ...
        class APIKey < Increase::Internal::Type::BaseModel
          OrHash = T.type_alias { T.any(Increase::WireTransfer::CreatedBy::APIKey, Increase::Internal::AnyHash) }
        ...
        module Category
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, Increase::WireTransfer::CreatedBy::Category) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          # An API key. Details will be under the `api_key` object.
          API_KEY = T.let(:api_key, Increase::WireTransfer::CreatedBy::Category::TaggedSymbol)

          # An OAuth application you connected to Increase. Details will be under the `oauth_application` object.
          OAUTH_APPLICATION = T.let(:oauth_application, Increase::WireTransfer::CreatedBy::Category::TaggedSymbol)

          # A User in the Increase dashboard. Details will be under the `user` object.
          USER = T.let(:user, Increase::WireTransfer::CreatedBy::Category::TaggedSymbol)

          sig { override.returns(T::Array[Increase::WireTransfer::CreatedBy::Category::TaggedSymbol]) }
          def self.values; end
        end

        class OAuthApplication < Increase::Internal::Type::BaseModel
          OrHash =
            T.type_alias { T.any(Increase::WireTransfer::CreatedBy::OAuthApplication, Increase::Internal::AnyHash) }
        ...
        class User < Increase::Internal::Type::BaseModel
          OrHash = T.type_alias { T.any(Increase::WireTransfer::CreatedBy::User, Increase::Internal::AnyHash) }
      ...
      module Currency
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::WireTransfer::Currency) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        sig { override.returns(T::Array[Increase::WireTransfer::Currency::TaggedSymbol]) }
        def self.values; end
      end
      ...
      module Network
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::WireTransfer::Network) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        WIRE = T.let(:wire, Increase::WireTransfer::Network::TaggedSymbol)

        sig { override.returns(T::Array[Increase::WireTransfer::Network::TaggedSymbol]) }
        def self.values; end
      end

      class Reversal < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::WireTransfer::Reversal, Increase::Internal::AnyHash) }
      ...
      module Status
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::WireTransfer::Status) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        # The transfer is pending approval.
        PENDING_APPROVAL = T.let(:pending_approval, Increase::WireTransfer::Status::TaggedSymbol)

        # The transfer has been canceled.
        CANCELED = T.let(:canceled, Increase::WireTransfer::Status::TaggedSymbol)

        # The transfer is pending review by Increase.
        PENDING_REVIEWING = T.let(:pending_reviewing, Increase::WireTransfer::Status::TaggedSymbol)

        # The transfer has been rejected by Increase.
        REJECTED = T.let(:rejected, Increase::WireTransfer::Status::TaggedSymbol)

        # The transfer requires attention from an Increase operator.
        REQUIRES_ATTENTION = T.let(:requires_attention, Increase::WireTransfer::Status::TaggedSymbol)

        # The transfer is pending creation.
        PENDING_CREATING = T.let(:pending_creating, Increase::WireTransfer::Status::TaggedSymbol)

        # The transfer has been reversed.
        REVERSED = T.let(:reversed, Increase::WireTransfer::Status::TaggedSymbol)

        # The transfer has been submitted to Fedwire.
        SUBMITTED = T.let(:submitted, Increase::WireTransfer::Status::TaggedSymbol)

        # The transfer has been acknowledged by Fedwire and can be considered complete.
        COMPLETE = T.let(:complete, Increase::WireTransfer::Status::TaggedSymbol)

        sig { override.returns(T::Array[Increase::WireTransfer::Status::TaggedSymbol]) }
        def self.values; end
      end

      class Submission < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::WireTransfer::Submission, Increase::Internal::AnyHash) }
      ...
      module Type
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::WireTransfer::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        WIRE_TRANSFER = T.let(:wire_transfer, Increase::WireTransfer::Type::TaggedSymbol)

        sig { override.returns(T::Array[Increase::WireTransfer::Type::TaggedSymbol]) }
        def self.values; end
      end
    end
  end
