  ...
  module Models
    class File < Increase::Internal::Type::BaseModel
      ...
      module Direction
        ...
        TO_INCREASE = T.let(:to_increase, Increase::File::Direction::TaggedSymbol)

        # This File was generated by Increase.
        FROM_INCREASE = T.let(:from_increase, Increase::File::Direction::TaggedSymbol)

        sig { override.returns(T::Array[Increase::File::Direction::TaggedSymbol]) }
        def self.values; end
      end
      ...
      module Purpose
        ...
        CHECK_IMAGE_FRONT = T.let(:check_image_front, Increase::File::Purpose::TaggedSymbol)

        # An image of the back of a check, used for check deposits.
        CHECK_IMAGE_BACK = T.let(:check_image_back, Increase::File::Purpose::TaggedSymbol)

        # An image of the front of a deposited check after processing by Increase and submission to the Federal Reserve.
        PROCESSED_CHECK_IMAGE_FRONT = T.let(:processed_check_image_front, Increase::File::Purpose::TaggedSymbol)

        # An image of the back of a deposited check after processing by Increase and submission to the Federal Reserve.
        PROCESSED_CHECK_IMAGE_BACK = T.let(:processed_check_image_back, Increase::File::Purpose::TaggedSymbol)

        # An image of a check that was mailed to a recipient.
        MAILED_CHECK_IMAGE = T.let(:mailed_check_image, Increase::File::Purpose::TaggedSymbol)

        # A document to be printed on an additional page and mailed with a check that you've requested Increase print.
        CHECK_ATTACHMENT = T.let(:check_attachment, Increase::File::Purpose::TaggedSymbol)

        # A scanned mail item sent to Increase.
        INBOUND_MAIL_ITEM = T.let(:inbound_mail_item, Increase::File::Purpose::TaggedSymbol)

        # IRS Form 1099-INT.
        FORM_1099_INT = T.let(:form_1099_int, Increase::File::Purpose::TaggedSymbol)

        # IRS Form 1099-MISC.
        FORM_1099_MISC = T.let(:form_1099_misc, Increase::File::Purpose::TaggedSymbol)

        # IRS Form SS-4.
        FORM_SS_4 = T.let(:form_ss_4, Increase::File::Purpose::TaggedSymbol)

        # An image of a government-issued ID.
        IDENTITY_DOCUMENT = T.let(:identity_document, Increase::File::Purpose::TaggedSymbol)

        # A statement generated by Increase.
        INCREASE_STATEMENT = T.let(:increase_statement, Increase::File::Purpose::TaggedSymbol)
        ...
        TRUST_FORMATION_DOCUMENT = T.let(:trust_formation_document, Increase::File::Purpose::TaggedSymbol)

        # A card image to be rendered inside digital wallet apps. This must be a 1536x969 pixel PNG.
        DIGITAL_WALLET_ARTWORK = T.let(:digital_wallet_artwork, Increase::File::Purpose::TaggedSymbol)

        # An icon for you app to be rendered inside digital wallet apps. This must be a 100x100 pixel PNG.
        DIGITAL_WALLET_APP_ICON = T.let(:digital_wallet_app_icon, Increase::File::Purpose::TaggedSymbol)
        ...
        PHYSICAL_CARD_FRONT = T.let(:physical_card_front, Increase::File::Purpose::TaggedSymbol)

        # The image to be printed on the back of a physical card.
        PHYSICAL_CARD_BACK = T.let(:physical_card_back, Increase::File::Purpose::TaggedSymbol)
        ...
        PHYSICAL_CARD_CARRIER = T.let(:physical_card_carrier, Increase::File::Purpose::TaggedSymbol)

        # A document requested by Increase.
        DOCUMENT_REQUEST = T.let(:document_request, Increase::File::Purpose::TaggedSymbol)

        # A supplemental document associated an an Entity.
        ENTITY_SUPPLEMENTAL_DOCUMENT =
          T.let(:entity_supplemental_document, Increase::File::Purpose::TaggedSymbol)
        ...
        UNUSUAL_ACTIVITY_REPORT_ATTACHMENT =
          T.let(:unusual_activity_report_attachment, Increase::File::Purpose::TaggedSymbol)

        # A document granting another entity access to the funds into your account.
        DEPOSIT_ACCOUNT_CONTROL_AGREEMENT =
          T.let(:deposit_account_control_agreement, Increase::File::Purpose::TaggedSymbol)

        # A file containing additional evidence for a Proof of Authorization Request Submission.
        PROOF_OF_AUTHORIZATION_REQUEST_SUBMISSION =
          T.let(:proof_of_authorization_request_submission, Increase::File::Purpose::TaggedSymbol)

        # An account verification letter.
        ACCOUNT_VERIFICATION_LETTER = T.let(:account_verification_letter, Increase::File::Purpose::TaggedSymbol)

        # Funding instructions.
        FUNDING_INSTRUCTIONS = T.let(:funding_instructions, Increase::File::Purpose::TaggedSymbol)

        # A Hold Harmless Letter.
        HOLD_HARMLESS_LETTER = T.let(:hold_harmless_letter, Increase::File::Purpose::TaggedSymbol)

        sig { override.returns(T::Array[Increase::File::Purpose::TaggedSymbol]) }
        def self.values; end
      end
