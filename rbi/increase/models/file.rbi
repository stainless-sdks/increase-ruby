  ...
  module Models
    class File < Increase::Internal::Type::BaseModel
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Increase::Models::File::Direction) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        # This File was sent by you to Increase.
        TO_INCREASE =
          T.let(:to_increase, Increase::Models::File::Direction::TaggedSymbol)

        # This File was generated by Increase.
        FROM_INCREASE =
          T.let(:from_increase, Increase::Models::File::Direction::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Increase::Models::File::Direction::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Purpose
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Increase::Models::File::Purpose) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        CHECK_IMAGE_FRONT =
          T.let(
            :check_image_front,
            Increase::Models::File::Purpose::TaggedSymbol
          )
        ...
        # IRS Form 1099-INT.
        FORM_1099_INT =
          T.let(:form_1099_int, Increase::Models::File::Purpose::TaggedSymbol)

        # IRS Form 1099-MISC.
        FORM_1099_MISC =
          T.let(:form_1099_misc, Increase::Models::File::Purpose::TaggedSymbol)

        # IRS Form SS-4.
        FORM_SS_4 =
          T.let(:form_ss_4, Increase::Models::File::Purpose::TaggedSymbol)
        ...
        sig do
          override.returns(
            T::Array[Increase::Models::File::Purpose::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Increase::Models::File::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        FILE = T.let(:file, Increase::Models::File::Type::TaggedSymbol)

        sig do
          override.returns(T::Array[Increase::Models::File::Type::TaggedSymbol])
        end
        def self.values
        end
      end
