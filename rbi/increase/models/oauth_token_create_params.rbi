...
module Increase
  module Models
    class OAuthTokenCreateParams < Increase::Internal::Type::BaseModel
      ...
      OrHash = T.type_alias { T.any(Increase::OAuthTokenCreateParams, Increase::Internal::AnyHash) }
      ...
      module GrantType
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::OAuthTokenCreateParams::GrantType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        # An OAuth authorization code.
        AUTHORIZATION_CODE =
          T.let(:authorization_code, Increase::OAuthTokenCreateParams::GrantType::TaggedSymbol)

        # An OAuth production token.
        PRODUCTION_TOKEN = T.let(:production_token, Increase::OAuthTokenCreateParams::GrantType::TaggedSymbol)

        sig { override.returns(T::Array[Increase::OAuthTokenCreateParams::GrantType::TaggedSymbol]) }
        def self.values; end
      end
    end
  end
