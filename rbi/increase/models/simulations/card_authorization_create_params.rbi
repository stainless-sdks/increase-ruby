  ...
  module Models
    module Simulations
      class CardAuthorizationCreateParams < Increase::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(Increase::Simulations::CardAuthorizationCreateParams::ProcessingCategory)) }
        attr_reader :processing_category

        sig do
          params(
            processing_category: Increase::Simulations::CardAuthorizationCreateParams::ProcessingCategory::OrHash
          )
            .void
        end
        ...
        class ProcessingCategory < Increase::Internal::Type::BaseModel
          ...
          sig { returns(Increase::Simulations::CardAuthorizationCreateParams::ProcessingCategory::Category::OrSymbol) }
          ...
          sig do
            params(
              category: Increase::Simulations::CardAuthorizationCreateParams::ProcessingCategory::Category::OrSymbol
            )
              .returns(T.attached_class)
          end
          def self.new(
          ...
          module Category
            ...
            TaggedSymbol =
              T.type_alias { T.all(Symbol, Increase::Simulations::CardAuthorizationCreateParams::ProcessingCategory::Category) }
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            sig do
              override
                .returns(
                  T::Array[Increase::Simulations::CardAuthorizationCreateParams::ProcessingCategory::Category::TaggedSymbol]
                )
            end
            def self.values; end
          end
