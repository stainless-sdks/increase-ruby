  ...
  module Models
    module Simulations
      class CardAuthorizationCreateResponse < Increase::Internal::Type::BaseModel
        OrHash =
          T.type_alias { T.any(Increase::Models::Simulations::CardAuthorizationCreateResponse, Increase::Internal::AnyHash) }
        ...
        sig { params(declined_transaction: T.nilable(Increase::DeclinedTransaction::OrHash)).void }
        ...
        sig { params(pending_transaction: T.nilable(Increase::PendingTransaction::OrHash)).void }
        ...
        sig do
          params(
            declined_transaction: T.nilable(Increase::DeclinedTransaction::OrHash),
