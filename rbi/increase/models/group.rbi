  ...
  module Models
    class Group < Increase::Internal::Type::BaseModel
      ...
      module ACHDebitStatus
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::Group::ACHDebitStatus) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        # The Group cannot make ACH debits.
        DISABLED = T.let(:disabled, Increase::Group::ACHDebitStatus::TaggedSymbol)

        # The Group can make ACH debits.
        ENABLED = T.let(:enabled, Increase::Group::ACHDebitStatus::TaggedSymbol)

        sig { override.returns(T::Array[Increase::Group::ACHDebitStatus::TaggedSymbol]) }
        def self.values; end
      end
      ...
      module ActivationStatus
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::Group::ActivationStatus) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        # The Group is not activated.
        UNACTIVATED = T.let(:unactivated, Increase::Group::ActivationStatus::TaggedSymbol)

        # The Group is activated.
        ACTIVATED = T.let(:activated, Increase::Group::ActivationStatus::TaggedSymbol)

        sig { override.returns(T::Array[Increase::Group::ActivationStatus::TaggedSymbol]) }
        def self.values; end
      end
