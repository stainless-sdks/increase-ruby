...
module Increase
  module Models
    class CardCreateParams < Increase::Internal::Type::BaseModel
      ...
      OrHash = T.type_alias { T.any(Increase::CardCreateParams, Increase::Internal::AnyHash) }
      ...
      sig { params(billing_address: Increase::CardCreateParams::BillingAddress::OrHash).void }
      ...
      sig { params(digital_wallet: Increase::CardCreateParams::DigitalWallet::OrHash).void }
      ...
      class BillingAddress < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::CardCreateParams::BillingAddress, Increase::Internal::AnyHash) }
      ...
      class DigitalWallet < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::CardCreateParams::DigitalWallet, Increase::Internal::AnyHash) }
