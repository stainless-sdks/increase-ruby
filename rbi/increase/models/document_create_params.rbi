...
module Increase
  module Models
    class DocumentCreateParams < Increase::Internal::Type::BaseModel
      ...
      OrHash = T.type_alias { T.any(Increase::DocumentCreateParams, Increase::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Increase::DocumentCreateParams::AccountVerificationLetter)) }
      attr_reader :account_verification_letter

      sig do
        params(account_verification_letter: Increase::DocumentCreateParams::AccountVerificationLetter::OrHash).void
      end
      attr_writer :account_verification_letter

      # Funding instructions.
      sig { returns(T.nilable(Increase::DocumentCreateParams::FundingInstructions)) }
      attr_reader :funding_instructions

      sig { params(funding_instructions: Increase::DocumentCreateParams::FundingInstructions::OrHash).void }
      ...
      module Category
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::DocumentCreateParams::Category) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        # An account verification letter.
        ACCOUNT_VERIFICATION_LETTER =
          T.let(:account_verification_letter, Increase::DocumentCreateParams::Category::TaggedSymbol)

        # Funding instructions.
        FUNDING_INSTRUCTIONS =
          T.let(:funding_instructions, Increase::DocumentCreateParams::Category::TaggedSymbol)

        sig { override.returns(T::Array[Increase::DocumentCreateParams::Category::TaggedSymbol]) }
        def self.values; end
      end

      class AccountVerificationLetter < Increase::Internal::Type::BaseModel
        OrHash =
          T.type_alias { T.any(Increase::DocumentCreateParams::AccountVerificationLetter, Increase::Internal::AnyHash) }
        ...
        # An account verification letter.
        sig { params(account_number_id: String, balance_date: Date).returns(T.attached_class) }
        def self.new(
          # The Account Number the bank letter should be generated for.
        account_number_id:,
          # If provided, the letter will include the Account's balance as of the date.
        ...
        sig { override.returns({account_number_id: String, balance_date: Date}) }
        def to_hash; end
      end

      class FundingInstructions < Increase::Internal::Type::BaseModel
        OrHash =
          T.type_alias { T.any(Increase::DocumentCreateParams::FundingInstructions, Increase::Internal::AnyHash) }
