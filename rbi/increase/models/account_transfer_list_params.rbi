...
module Increase
  module Models
    class AccountTransferListParams < Increase::Internal::Type::BaseModel
      ...
      OrHash = T.type_alias { T.any(Increase::AccountTransferListParams, Increase::Internal::AnyHash) }
      ...
      sig { params(created_at: Increase::AccountTransferListParams::CreatedAt::OrHash).void }
      ...
      class CreatedAt < Increase::Internal::Type::BaseModel
        OrHash =
          T.type_alias { T.any(Increase::AccountTransferListParams::CreatedAt, Increase::Internal::AnyHash) }
