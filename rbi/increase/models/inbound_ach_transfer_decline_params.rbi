...
module Increase
  module Models
    class InboundACHTransferDeclineParams < Increase::Internal::Type::BaseModel
      ...
      OrHash = T.type_alias { T.any(Increase::InboundACHTransferDeclineParams, Increase::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Increase::InboundACHTransferDeclineParams::Reason::OrSymbol)) }
      attr_reader :reason

      sig { params(reason: Increase::InboundACHTransferDeclineParams::Reason::OrSymbol).void }
      attr_writer :reason
      ...
      module Reason
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::InboundACHTransferDeclineParams::Reason) }
        ...
        INSUFFICIENT_FUNDS =
          T.let(:insufficient_funds, Increase::InboundACHTransferDeclineParams::Reason::TaggedSymbol)
        ...
        RETURNED_PER_ODFI_REQUEST =
          T.let(:returned_per_odfi_request, Increase::InboundACHTransferDeclineParams::Reason::TaggedSymbol)

        # The customer no longer authorizes this transaction. The Nacha return code is R07.
        AUTHORIZATION_REVOKED_BY_CUSTOMER =
          T.let(:authorization_revoked_by_customer, Increase::InboundACHTransferDeclineParams::Reason::TaggedSymbol)

        # The customer asked for the payment to be stopped. This reason is only allowed for debits. The Nacha return code is R08.
        PAYMENT_STOPPED =
          T.let(:payment_stopped, Increase::InboundACHTransferDeclineParams::Reason::TaggedSymbol)
        ...
        CREDIT_ENTRY_REFUSED_BY_RECEIVER =
          T.let(:credit_entry_refused_by_receiver, Increase::InboundACHTransferDeclineParams::Reason::TaggedSymbol)

        # The account holder identified this transaction as a duplicate. The Nacha return code is R24.
        DUPLICATE_ENTRY =
          T.let(:duplicate_entry, Increase::InboundACHTransferDeclineParams::Reason::TaggedSymbol)
        ...
        sig { override.returns(T::Array[Increase::InboundACHTransferDeclineParams::Reason::TaggedSymbol]) }
        def self.values; end
      end
    end
  end
