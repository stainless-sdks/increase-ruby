  ...
  module Models
    class EventSubscription < Increase::Internal::Type::BaseModel
      ...
      sig do
        params(
          ...
          selected_event_category:
            T.nilable(
              Increase::Models::EventSubscription::SelectedEventCategory::OrSymbol
            ),
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Increase::Models::EventSubscription::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        ACTIVE =
          T.let(
            :active,
            Increase::Models::EventSubscription::Status::TaggedSymbol
          )
        ...
        sig do
          override.returns(
            T::Array[Increase::Models::EventSubscription::Status::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Increase::Models::EventSubscription::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        EVENT_SUBSCRIPTION =
          T.let(
            :event_subscription,
            Increase::Models::EventSubscription::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Increase::Models::EventSubscription::Type::TaggedSymbol]
          )
        end
        def self.values
        end
