...
module Increase
  module Models
    class InboundCheckDepositListParams < Increase::Internal::Type::BaseModel
      ...
      OrHash = T.type_alias { T.any(Increase::InboundCheckDepositListParams, Increase::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Increase::InboundCheckDepositListParams::CreatedAt)) }
      attr_reader :created_at

      sig { params(created_at: Increase::InboundCheckDepositListParams::CreatedAt::OrHash).void }
      ...
      class CreatedAt < Increase::Internal::Type::BaseModel
        OrHash =
          T.type_alias { T.any(Increase::InboundCheckDepositListParams::CreatedAt, Increase::Internal::AnyHash) }
