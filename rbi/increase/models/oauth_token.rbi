...
module Increase
  module Models
    class OAuthToken < Increase::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Increase::OAuthToken, Increase::Internal::AnyHash) }
      ...
      module TokenType
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::OAuthToken::TokenType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        BEARER = T.let(:bearer, Increase::OAuthToken::TokenType::TaggedSymbol)

        sig { override.returns(T::Array[Increase::OAuthToken::TokenType::TaggedSymbol]) }
        def self.values; end
      end
      ...
      module Type
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Increase::OAuthToken::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        OAUTH_TOKEN = T.let(:oauth_token, Increase::OAuthToken::Type::TaggedSymbol)

        sig { override.returns(T::Array[Increase::OAuthToken::Type::TaggedSymbol]) }
        def self.values; end
      end
    end
  end
