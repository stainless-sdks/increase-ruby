      ...
      sig do
        params(
          cancellation:
            T.nilable(
              T.any(
                Increase::Models::CheckTransfer::Cancellation,
                Increase::Internal::AnyHash
              )
            )
        ).void
      ...
      sig do
        params(
          created_by:
            T.nilable(
              T.any(
                Increase::Models::CheckTransfer::CreatedBy,
                Increase::Internal::AnyHash
              )
            )
        ).void
        ...
        sig do
          params(
            api_key:
              T.nilable(
                T.any(
                  Increase::Models::CheckTransfer::CreatedBy::APIKey,
                  Increase::Internal::AnyHash
                )
              )
          ).void
        ...
        sig do
          params(
            user:
              T.nilable(
                T.any(
                  Increase::Models::CheckTransfer::CreatedBy::User,
                  Increase::Internal::AnyHash
                )
              )
          ).void
