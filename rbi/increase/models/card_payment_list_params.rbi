...
module Increase
  module Models
    class CardPaymentListParams < Increase::Internal::Type::BaseModel
      ...
      OrHash = T.type_alias { T.any(Increase::CardPaymentListParams, Increase::Internal::AnyHash) }
      ...
      sig { params(created_at: Increase::CardPaymentListParams::CreatedAt::OrHash).void }
      ...
      class CreatedAt < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::CardPaymentListParams::CreatedAt, Increase::Internal::AnyHash) }
