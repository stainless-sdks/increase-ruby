...
module Increase
  module Models
    class PhysicalCardProfileCloneParams < Increase::Internal::Type::BaseModel
      ...
      OrHash = T.type_alias { T.any(Increase::PhysicalCardProfileCloneParams, Increase::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Increase::PhysicalCardProfileCloneParams::FrontText)) }
      attr_reader :front_text

      sig { params(front_text: Increase::PhysicalCardProfileCloneParams::FrontText::OrHash).void }
      ...
      sig do
        params(
          ...
          front_text: Increase::PhysicalCardProfileCloneParams::FrontText::OrHash,
      ...
      class FrontText < Increase::Internal::Type::BaseModel
        OrHash =
          T.type_alias { T.any(Increase::PhysicalCardProfileCloneParams::FrontText, Increase::Internal::AnyHash) }
