  ...
  module Models
    class Event < Increase::Internal::Type::BaseModel
      ...
      module Category
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Increase::Models::Event::Category) }
        ...
        sig do
          override.returns(
            T::Array[Increase::Models::Event::Category::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Increase::Models::Event::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        sig do
          override.returns(
            T::Array[Increase::Models::Event::Type::TaggedSymbol]
          )
        end
        def self.values
        end
