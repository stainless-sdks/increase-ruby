...
module Increase
  module Models
    class Document < Increase::Internal::Type::BaseModel
      ...
      sig { params(funding_instructions: T.nilable(Increase::Document::FundingInstructions::OrHash)).void }
      ...
      sig do
        params(
          ...
          file_id: String,
          funding_instructions: T.nilable(Increase::Document::FundingInstructions::OrHash),
          ...
          .returns(
            {
              ...
              entity_id: T.nilable(String),
              file_id: String,
              funding_instructions: T.nilable(Increase::Document::FundingInstructions),
              idempotency_key: T.nilable(String),
      ...
      module Category
        ...
        FUNDING_INSTRUCTIONS = T.let(:funding_instructions, Increase::Document::Category::TaggedSymbol)
      ...
      class FundingInstructions < Increase::Internal::Type::BaseModel
        OrHash = T.type_alias { T.any(Increase::Document::FundingInstructions, Increase::Internal::AnyHash) }
