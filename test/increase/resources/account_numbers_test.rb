...
class Increase::Test::Resources::AccountNumbersTest < Increase::Test::ResourceTest
  def test_create_required_params
    response =
      @client.account_numbers.create(account_id: "account_in71c4amph0vgo2qllky", name: "Rent payments")
  ...
  def test_retrieve
    response = @client.account_numbers.retrieve("account_number_id")
  ...
  def test_update
    response = @client.account_numbers.update("account_number_id")
  ...
  def test_list
    response = @client.account_numbers.list
