...
class Increase::Test::PrimitiveModelTest < Minitest::Test
  A = Increase::ArrayOf[-> { Integer }]
  H = Increase::HashOf[-> { Integer }, nil?: true]
  ...
  def test_coerce
    cases = {
      [Increase::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Increase::BooleanModel, true] => [{yes: 1}, true],
      [Increase::BooleanModel, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
  ...
  def test_dump
    cases = {
      [Increase::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Increase::BooleanModel, true] => true,
      [Increase::BooleanModel, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
...
class Increase::Test::CollectionModelTest < Minitest::Test
  A1 = Increase::ArrayOf[-> { Integer }]
  H1 = Increase::HashOf[Integer]

  A2 = Increase::ArrayOf[H1]
  H2 = Increase::HashOf[-> { A1 }]

  A3 = Increase::ArrayOf[Integer, nil?: true]
  H3 = Increase::HashOf[Integer, nil?: true]
...
class Increase::Test::BaseModelTest < Minitest::Test
  ...
  class M6 < M1
    required :a, Increase::ArrayOf[M6]
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        ...
        if coerced.is_a?(Increase::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
...
class Increase::Test::UnionTest < Minitest::Test
  ...
  class M4 < Increase::BaseModel
    optional :recur, -> { U5 }
    required :a, Increase::ArrayOf[-> { U5 }]
  end

  class M5 < Increase::BaseModel
    optional :recur, -> { U5 }
    required :b, Increase::ArrayOf[-> { U5 }]
  end
  ...
  def test_accessors
    ...
    tap do
      model.recur
      flunk
    rescue Increase::ConversionError => e
...
class Increase::Test::BaseModelQoLTest < Minitest::Test
  ...
  def test_equality
    cases = {
      [Increase::Unknown, Increase::Unknown] => true,
      [Increase::BooleanModel, Increase::BooleanModel] => true,
      [Increase::Unknown, Increase::BooleanModel] => false,
      [E1, E2] => true,
      [E1, E3] => false,
      [M1, M2] => false,
      [M1, M3] => true
