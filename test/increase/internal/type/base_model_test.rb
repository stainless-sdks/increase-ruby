...
class Increase::Test::PrimitiveModelTest < Minitest::Test
  A = Increase::Internal::Type::ArrayOf[-> { Integer }]
  H = Increase::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Increase::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Increase::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        Increase::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Increase::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [String, Pathname(__FILE__)] => Increase::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Increase::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Increase::Internal::Type::Converter.new_coerce_state
      Increase::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
...
class Increase::Test::CollectionModelTest < Minitest::Test
  A1 = Increase::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Increase::Internal::Type::HashOf[Integer]

  A2 = Increase::Internal::Type::ArrayOf[H1]
  H2 = Increase::Internal::Type::HashOf[-> { A1 }]

  A3 = Increase::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Increase::Internal::Type::HashOf[Integer, nil?: true]
...
class Increase::Test::BaseModelTest < Minitest::Test
  class M1 < Increase::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Increase::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Increase::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Increase::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Increase::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Increase::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Increase::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Increase::Errors::ConversionError => e
...
class Increase::Test::UnionTest < Minitest::Test
  class U0
    include Increase::Internal::Type::Union
  ...
  class M2 < Increase::Internal::Type::BaseModel
  ...
  class M4 < Increase::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Increase::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Increase::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Increase::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Increase::Test::MetaInfoTest < Minitest::Test
  A1 = Increase::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Increase::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
