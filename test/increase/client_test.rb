...
class IncreaseTest < Minitest::Test
  ...
  def test_client_redirect_307
    ...
    assert_equal(requester.attempts.first.fetch(:headers)["content-type"], requester.attempts.last.fetch(:headers)["content-type"])
  end
  ...
  def test_client_redirect_auth_keep_same_origin
    ...
    assert_equal(requester.attempts.first.fetch(:headers)["authorization"], requester.attempts.last.fetch(:headers)["authorization"])
  end
