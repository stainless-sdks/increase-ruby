    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in Increase::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [Increase::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(Increase::Type::Converter) ? target.dump(value) : Increase::Unknown.dump(value)
        end
      end
    end
  end
