...
module Increase
  module Type
    ...
    #   }
    class BaseModel
      extend Increase::Type::Converter
      ...
      class << self
        ...
        #
        # @param type_info [Hash{Symbol=>Object}, Proc, Increase::Type::Converter, Class]
        #
        ...
        private def add_field(name_sym, required:, type_info:, spec:)
          type_fn, info =
            case type_info
            in Proc | Increase::Type::Converter | Class
              [Increase::Type::Converter.type_info({**spec, union: type_info}), spec]
            in Hash
              [Increase::Type::Converter.type_info(type_info), type_info]
            end
          ...
          define_method(name_sym) do
            ...
            if (nilable || !required) && value.nil?
              ...
              Increase::Type::Converter.coerce(
                target,
                value,
                state: state
              )
          ...
          fields.each do |name, field|
            ...
            converted =
              if item.nil? && (nilable || !required)
                ...
                coerced = Increase::Type::Converter.coerce(target, item, state: state)
                case target
                in Increase::Type::Converter | Symbol
                  coerced
                else
                  item
                end
          ...
          coerced.each do |key, val|
            ...
            in nil
              ...
              in :coerce
                ...
                target = type_fn.call
                acc.store(api_name, Increase::Type::Converter.dump(target, val))
              end
            end
          end
