...
module Increase
  module Transport
    ...
    class BaseClient
      ...
      # @api private
      # @return [Increase::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = Increase::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [Increase::Type::Converter, Class, nil] :model
      #
      ...
      def request(req)
        ...
        decoded = Increase::Util.decode_content(response, stream: stream)
        case req
        in { stream: Class => st }
        ...
        in { page: Class => page }
          ...
          Increase::Type::Converter.coerce(model, unwrapped)
        end
      end
