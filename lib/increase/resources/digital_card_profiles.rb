...
module Increase
  module Resources
    class DigitalCardProfiles
      ...
      # @option params [Increase::Models::UnnamedSchemaRef02e643964e34301970969b6fc2fecae0] :text_color The Card's text color, specified as an RGB triple. The default is white.
      #
