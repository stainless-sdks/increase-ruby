...
module Increase
  module Resources
    class Cards
      ...
      #   @option params [Increase::Models::CardCreateParams::BillingAddress, nil] :billing_address The card's billing address.
      #   @option params [String, nil] :description The description you choose to give the card.
      #   @option params [Increase::Models::CardCreateParams::DigitalWallet, nil] :digital_wallet The contact information used in the two-factor steps for digital wallet card
      ...
      #
      # @param params [Hash{Symbol => Object}] Attributes to send in this request.
      #   @option params [Increase::Models::CardUpdateParams::BillingAddress, nil] :billing_address The card's updated billing address.
      #   @option params [String, nil] :description The description you choose to give the card.
      #   @option params [Increase::Models::CardUpdateParams::DigitalWallet, nil] :digital_wallet The contact information used in the two-factor steps for digital wallet card
      #     creation. At least one field must be present to complete the digital wallet
      #     steps.
      #   @option params [String, nil] :entity_id The Entity the card belongs to. You only need to supply this in rare situations
      #     when the card is not for the Account holder.
      #   @option params [Symbol, Increase::Models::CardUpdateParams::Status, nil] :status The status to update the Card with.
      #
      # @param opts [Hash{Symbol => Object}, Increase::RequestOptions] Options to specify HTTP behaviour for this request.
      #
      # @return [Increase::Models::Card]
      ...
      #   @option params [Increase::Models::CardListParams::CreatedAt, nil] :created_at
