...
module Increase
  module Models
    class InboundWireTransfer < BaseModel
      ...
      # @param sender_reference [String] The sending bank's reference number for the wire transfer.
