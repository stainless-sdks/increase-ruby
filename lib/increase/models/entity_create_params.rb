...
module Increase
  module Models
    ...
    class EntityCreateParams < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Increase::EntityCreateParams::Structure]
      ...
      #   `corporation`.
      #
      #   @return [Increase::EntityCreateParams::Corporation, nil]
      ...
      #
      #   @return [Increase::EntityCreateParams::GovernmentAuthority, nil]
      ...
      #   `joint`.
      #
      #   @return [Increase::EntityCreateParams::Joint, nil]
      ...
      #
      #   @return [Increase::EntityCreateParams::NaturalPerson, nil]
      optional :natural_person, -> { Increase::EntityCreateParams::NaturalPerson }

      # @!attribute supplemental_documents
      #   Additional documentation associated with the entity.
      #
      #   @return [Array<Increase::EntityCreateParams::SupplementalDocument>, nil]
      ...
      #
      #   @return [Increase::EntityCreateParams::ThirdPartyVerification, nil]
      ...
      #   `trust`.
      #
      #   @return [Increase::EntityCreateParams::Trust, nil]
      ...
      class Corporation < Increase::Internal::Type::BaseModel
        ...
        #   are disallowed.
        #
        #   @return [Increase::EntityCreateParams::Corporation::Address]
        ...
        #
        #   @return [Array<Increase::EntityCreateParams::Corporation::BeneficialOwner>]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Increase::EntityCreateParams::Corporation} for more details.
        #
        #   Details of the corporation entity to create. Required if `structure` is equal to
        #   `corporation`.
        #
        ...
        # @see Increase::EntityCreateParams::Corporation#address
        class Address < Increase::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Increase::EntityCreateParams::Corporation::Address} for more details.
          #
          #   The entity's physical address. Mail receiving locations like PO Boxes and PMB's
          #   are disallowed.
          #
        ...
        class BeneficialOwner < Increase::Internal::Type::BaseModel
          ...
          #
          #   @return [Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual]
          ...
          #
          #   @return [Array<Symbol, Increase::EntityCreateParams::Corporation::BeneficialOwner::Prong>]
          required :prongs,
                   -> {
          ...
          #   Some parameter documentations has been truncated, see
          #   {Increase::EntityCreateParams::Corporation::BeneficialOwner} for more details.
          #
          ...
          # @see Increase::EntityCreateParams::Corporation::BeneficialOwner#individual
          class Individual < Increase::Internal::Type::BaseModel
            # @!attribute address
            #   The individual's physical address. Mail receiving locations like PO Boxes and
            #   PMB's are disallowed.
            #
            #   @return [Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Address]
            required :address,
                     -> {
            ...
            #
            #   @return [Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification]
            ...
            #   Some parameter documentations has been truncated, see
            #   {Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual} for
            #   more details.
            #
            #   Personal details for the beneficial owner.
            #
            ...
            #
            #   @param identification [Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification] A means of verifying the person's identity.
            #
            ...
            # @see Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual#identification
            class Identification < Increase::Internal::Type::BaseModel
              # @!attribute method_
              #   A method that can be used to verify the individual's identity.
              #
              #   @return [Symbol, Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification::Method]
              required :method_,
                       enum: -> {
              ...
              #
              #   @return [Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification::DriversLicense, nil]
              ...
              #   equal to `other`.
              #
              #   @return [Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification::Other, nil]
              optional :other,
                       -> {
              ...
              #   equal to `passport`.
              #
              #   @return [Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification::Passport, nil]
              optional :passport,
                       -> {
              ...
              # A method that can be used to verify the individual's identity.
              #
              # @see Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification#method_
              module Method
                extend Increase::Internal::Type::Enum
              ...
              # @see Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification#drivers_license
              ...
              # @see Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification#other
              ...
              # @see Increase::EntityCreateParams::Corporation::BeneficialOwner::Individual::Identification#passport
        ...
        # list of beneficial owners.
        #
        # @see Increase::EntityCreateParams::Corporation#beneficial_ownership_exemption_reason
      ...
      class GovernmentAuthority < Increase::Internal::Type::BaseModel
        ...
        #   are disallowed.
        #
        #   @return [Increase::EntityCreateParams::GovernmentAuthority::Address]
        ...
        #
        #   @return [Array<Increase::EntityCreateParams::GovernmentAuthority::AuthorizedPerson>]
        ...
        #
        #   @return [Symbol, Increase::EntityCreateParams::GovernmentAuthority::Category]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Increase::EntityCreateParams::GovernmentAuthority} for more details.
        #
        #   Details of the Government Authority entity to create. Required if `structure` is
        #   equal to `Government Authority`.
        #
        ...
        #
        #   @param category [Symbol, Increase::EntityCreateParams::GovernmentAuthority::Category] The category of the government authority.
        #
        ...
        # @see Increase::EntityCreateParams::GovernmentAuthority#address
        class Address < Increase::Internal::Type::BaseModel
          # @!attribute city
          #   The city of the address.
          #
          ...
          # @!method initialize(city:, line1:, state:, zip:, line2: nil)
          #   Some parameter documentations has been truncated, see
          #   {Increase::EntityCreateParams::GovernmentAuthority::Address} for more details.
          #
          #   The entity's physical address. Mail receiving locations like PO Boxes and PMB's
          #   are disallowed.
          #
        ...
        # The category of the government authority.
        #
        # @see Increase::EntityCreateParams::GovernmentAuthority#category
        module Category
          extend Increase::Internal::Type::Enum
      ...
      class Joint < Increase::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Increase::EntityCreateParams::Joint::Individual>]
        ...
        #   `joint`.
        #
        #   @param individuals [Array<Increase::EntityCreateParams::Joint::Individual>] The two individuals that share control of the entity.
        #
        ...
        class Individual < Increase::Internal::Type::BaseModel
          ...
          #   PMB's are disallowed.
          #
          #   @return [Increase::EntityCreateParams::Joint::Individual::Address]
          ...
          #   A means of verifying the person's identity.
          #
          #   @return [Increase::EntityCreateParams::Joint::Individual::Identification]
          ...
          #   @param date_of_birth [Date] The person's date of birth in YYYY-MM-DD format.
          #
          #   @param identification [Increase::EntityCreateParams::Joint::Individual::Identification] A means of verifying the person's identity.
          #
          #   @param name [String] The person's legal name.
          #
          #   @param confirmed_no_us_tax_id [Boolean] The identification method for an individual can only be a passport, driver's lic
          ...
          class Address < Increase::Internal::Type::BaseModel
            ...
            # @!method initialize(city:, line1:, state:, zip:, line2: nil)
            #   Some parameter documentations has been truncated, see
            #   {Increase::EntityCreateParams::Joint::Individual::Address} for more details.
            #
            #   The individual's physical address. Mail receiving locations like PO Boxes and
            #   PMB's are disallowed.
            #
          ...
          # @see Increase::EntityCreateParams::Joint::Individual#identification
          class Identification < Increase::Internal::Type::BaseModel
            # @!attribute method_
            #   A method that can be used to verify the individual's identity.
            #
            #   @return [Symbol, Increase::EntityCreateParams::Joint::Individual::Identification::Method]
            required :method_,
            ...
            #   Required if `method` is equal to `drivers_license`.
            #
            #   @return [Increase::EntityCreateParams::Joint::Individual::Identification::DriversLicense, nil]
            optional :drivers_license,
            ...
            #   equal to `other`.
            #
            #   @return [Increase::EntityCreateParams::Joint::Individual::Identification::Other, nil]
            ...
            #   equal to `passport`.
            #
            #   @return [Increase::EntityCreateParams::Joint::Individual::Identification::Passport, nil]
            optional :passport,
                     -> {
            ...
            # @!method initialize(method_:, number:, drivers_license: nil, other: nil, passport: nil)
            #   Some parameter documentations has been truncated, see
            #   {Increase::EntityCreateParams::Joint::Individual::Identification} for more
            #   details.
            #
            #   A means of verifying the person's identity.
            #
            ...
            # A method that can be used to verify the individual's identity.
            #
            # @see Increase::EntityCreateParams::Joint::Individual::Identification#method_
            module Method
              extend Increase::Internal::Type::Enum
            ...
            # @see Increase::EntityCreateParams::Joint::Individual::Identification#drivers_license
            class DriversLicense < Increase::Internal::Type::BaseModel
              # @!attribute expiration_date
              #   The driver's license's expiration date in YYYY-MM-DD format.
              #
            ...
            # @see Increase::EntityCreateParams::Joint::Individual::Identification#other
            class Other < Increase::Internal::Type::BaseModel
              # @!attribute country
              #   The two-character ISO 3166-1 code representing the country that issued the
              #   document.
              ...
              # @!method initialize(country:, description:, file_id:, back_file_id: nil, expiration_date: nil)
              #   Some parameter documentations has been truncated, see
              #   {Increase::EntityCreateParams::Joint::Individual::Identification::Other} for
              #   more details.
              #
              #   Information about the identification document provided. Required if `method` is
              #   equal to `other`.
            ...
            # @see Increase::EntityCreateParams::Joint::Individual::Identification#passport
            class Passport < Increase::Internal::Type::BaseModel
              # @!attribute country
              #   The country that issued the passport.
              #
      ...
      class NaturalPerson < Increase::Internal::Type::BaseModel
        ...
        #   PMB's are disallowed.
        #
        #   @return [Increase::EntityCreateParams::NaturalPerson::Address]
        ...
        #   A means of verifying the person's identity.
        #
        #   @return [Increase::EntityCreateParams::NaturalPerson::Identification]
        ...
        # @!method initialize(address:, date_of_birth:, identification:, name:, confirmed_no_us_tax_id: nil)
        #   Some parameter documentations has been truncated, see
        #   {Increase::EntityCreateParams::NaturalPerson} for more details.
        #
        #   Details of the natural person entity to create. Required if `structure` is equal
        #   to `natural_person`. Natural people entities should be submitted with
        #   `social_security_number` or `individual_taxpayer_identification_number`
        ...
        #   @param date_of_birth [Date] The person's date of birth in YYYY-MM-DD format.
        #
        #   @param identification [Increase::EntityCreateParams::NaturalPerson::Identification] A means of verifying the person's identity.
        #
        #   @param name [String] The person's legal name.
        #
        #   @param confirmed_no_us_tax_id [Boolean] The identification method for an individual can only be a passport, driver's lic
        ...
        class Address < Increase::Internal::Type::BaseModel
          ...
          # @!method initialize(city:, line1:, state:, zip:, line2: nil)
          #   Some parameter documentations has been truncated, see
          #   {Increase::EntityCreateParams::NaturalPerson::Address} for more details.
          #
          #   The individual's physical address. Mail receiving locations like PO Boxes and
          #   PMB's are disallowed.
          #
        ...
        # @see Increase::EntityCreateParams::NaturalPerson#identification
        class Identification < Increase::Internal::Type::BaseModel
          # @!attribute method_
          #   A method that can be used to verify the individual's identity.
          #
          #   @return [Symbol, Increase::EntityCreateParams::NaturalPerson::Identification::Method]
          required :method_,
          ...
          #   Required if `method` is equal to `drivers_license`.
          #
          #   @return [Increase::EntityCreateParams::NaturalPerson::Identification::DriversLicense, nil]
          optional :drivers_license,
          ...
          #   equal to `other`.
          #
          #   @return [Increase::EntityCreateParams::NaturalPerson::Identification::Other, nil]
          ...
          #   equal to `passport`.
          #
          #   @return [Increase::EntityCreateParams::NaturalPerson::Identification::Passport, nil]
          optional :passport, -> { Increase::EntityCreateParams::NaturalPerson::Identification::Passport }

          # @!method initialize(method_:, number:, drivers_license: nil, other: nil, passport: nil)
          #   Some parameter documentations has been truncated, see
          #   {Increase::EntityCreateParams::NaturalPerson::Identification} for more details.
          #
          #   A means of verifying the person's identity.
          #
          ...
          # A method that can be used to verify the individual's identity.
          #
          # @see Increase::EntityCreateParams::NaturalPerson::Identification#method_
          module Method
            extend Increase::Internal::Type::Enum
          ...
          # @see Increase::EntityCreateParams::NaturalPerson::Identification#drivers_license
          class DriversLicense < Increase::Internal::Type::BaseModel
            # @!attribute expiration_date
            #   The driver's license's expiration date in YYYY-MM-DD format.
            #
          ...
          # @see Increase::EntityCreateParams::NaturalPerson::Identification#other
          class Other < Increase::Internal::Type::BaseModel
            # @!attribute country
            #   The two-character ISO 3166-1 code representing the country that issued the
            #   document.
            ...
            # @!method initialize(country:, description:, file_id:, back_file_id: nil, expiration_date: nil)
            #   Some parameter documentations has been truncated, see
            #   {Increase::EntityCreateParams::NaturalPerson::Identification::Other} for more
            #   details.
            #
            #   Information about the identification document provided. Required if `method` is
            #   equal to `other`.
          ...
          # @see Increase::EntityCreateParams::NaturalPerson::Identification#passport
          class Passport < Increase::Internal::Type::BaseModel
            # @!attribute country
            #   The country that issued the passport.
            #
      ...
      class ThirdPartyVerification < Increase::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Increase::EntityCreateParams::ThirdPartyVerification::Vendor]
        ...
        #
        #   @param vendor [Symbol, Increase::EntityCreateParams::ThirdPartyVerification::Vendor] The vendor that was used to perform the verification.

        # The vendor that was used to perform the verification.
        #
        # @see Increase::EntityCreateParams::ThirdPartyVerification#vendor
        module Vendor
          extend Increase::Internal::Type::Enum
      ...
      class Trust < Increase::Internal::Type::BaseModel
        ...
        #   are disallowed.
        #
        #   @return [Increase::EntityCreateParams::Trust::Address]
        ...
        #
        #   @return [Symbol, Increase::EntityCreateParams::Trust::Category]
        ...
        #
        #   @return [Array<Increase::EntityCreateParams::Trust::Trustee>]
        required :trustees,
                 -> {
        ...
        #
        #   @return [Increase::EntityCreateParams::Trust::Grantor, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Increase::EntityCreateParams::Trust} for more details.
        #
        #   Details of the trust entity to create. Required if `structure` is equal to
        #   `trust`.
        #
        ...
        #
        #   @param trustees [Array<Increase::EntityCreateParams::Trust::Trustee>] The trustees of the trust.
        #
        ...
        class Address < Increase::Internal::Type::BaseModel
          ...
          # @!method initialize(city:, line1:, state:, zip:, line2: nil)
          #   Some parameter documentations has been truncated, see
          #   {Increase::EntityCreateParams::Trust::Address} for more details.
          #
          #   The trust's physical address. Mail receiving locations like PO Boxes and PMB's
          #   are disallowed.
          #
        ...
        # about the individual `grantor` who created the trust.
        #
        # @see Increase::EntityCreateParams::Trust#category
        module Category
          extend Increase::Internal::Type::Enum
        ...
        class Trustee < Increase::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Increase::EntityCreateParams::Trust::Trustee::Structure]
          ...
          #   equal to `individual`.
          #
          #   @return [Increase::EntityCreateParams::Trust::Trustee::Individual, nil]
          optional :individual, -> { Increase::EntityCreateParams::Trust::Trustee::Individual }

          # @!method initialize(structure:, individual: nil)
          #   Some parameter documentations has been truncated, see
          #   {Increase::EntityCreateParams::Trust::Trustee} for more details.
          #
          ...
          # The structure of the trustee.
          #
          # @see Increase::EntityCreateParams::Trust::Trustee#structure
          module Structure
            extend Increase::Internal::Type::Enum
          ...
          # @see Increase::EntityCreateParams::Trust::Trustee#individual
          class Individual < Increase::Internal::Type::BaseModel
            # @!attribute address
            #   The individual's physical address. Mail receiving locations like PO Boxes and
            #   PMB's are disallowed.
            #
            #   @return [Increase::EntityCreateParams::Trust::Trustee::Individual::Address]
            ...
            #   A means of verifying the person's identity.
            #
            #   @return [Increase::EntityCreateParams::Trust::Trustee::Individual::Identification]
            required :identification,
                     -> {
            ...
            # @!method initialize(address:, date_of_birth:, identification:, name:, confirmed_no_us_tax_id: nil)
            #   Some parameter documentations has been truncated, see
            #   {Increase::EntityCreateParams::Trust::Trustee::Individual} for more details.
            #
            #   Details of the individual trustee. Required when the trustee `structure` is
            #   equal to `individual`.
            #
            ...
            #   @param date_of_birth [Date] The person's date of birth in YYYY-MM-DD format.
            #
            #   @param identification [Increase::EntityCreateParams::Trust::Trustee::Individual::Identification] A means of verifying the person's identity.
            #
            #   @param name [String] The person's legal name.
            #
            #   @param confirmed_no_us_tax_id [Boolean] The identification method for an individual can only be a passport, driver's lic
            ...
            class Address < Increase::Internal::Type::BaseModel
              ...
              # @!method initialize(city:, line1:, state:, zip:, line2: nil)
              #   Some parameter documentations has been truncated, see
              #   {Increase::EntityCreateParams::Trust::Trustee::Individual::Address} for more
              #   details.
              #
              #   The individual's physical address. Mail receiving locations like PO Boxes and
              #   PMB's are disallowed.
            ...
            # @see Increase::EntityCreateParams::Trust::Trustee::Individual#identification
            class Identification < Increase::Internal::Type::BaseModel
              # @!attribute method_
              #   A method that can be used to verify the individual's identity.
              #
              #   @return [Symbol, Increase::EntityCreateParams::Trust::Trustee::Individual::Identification::Method]
              required :method_,
                       enum: -> {
              ...
              #   Required if `method` is equal to `drivers_license`.
              #
              #   @return [Increase::EntityCreateParams::Trust::Trustee::Individual::Identification::DriversLicense, nil]
              optional :drivers_license,
                       -> {
              ...
              #   equal to `other`.
              #
              #   @return [Increase::EntityCreateParams::Trust::Trustee::Individual::Identification::Other, nil]
              optional :other,
                       -> {
              ...
              #   equal to `passport`.
              #
              #   @return [Increase::EntityCreateParams::Trust::Trustee::Individual::Identification::Passport, nil]
              optional :passport,
                       -> {
              ...
              # @!method initialize(method_:, number:, drivers_license: nil, other: nil, passport: nil)
              #   Some parameter documentations has been truncated, see
              #   {Increase::EntityCreateParams::Trust::Trustee::Individual::Identification} for
              #   more details.
              #
              #   A means of verifying the person's identity.
              #
              ...
              # A method that can be used to verify the individual's identity.
              #
              # @see Increase::EntityCreateParams::Trust::Trustee::Individual::Identification#method_
              module Method
                extend Increase::Internal::Type::Enum
              ...
              # @see Increase::EntityCreateParams::Trust::Trustee::Individual::Identification#drivers_license
              class DriversLicense < Increase::Internal::Type::BaseModel
                # @!attribute expiration_date
                #   The driver's license's expiration date in YYYY-MM-DD format.
                #
              ...
              # @see Increase::EntityCreateParams::Trust::Trustee::Individual::Identification#other
              class Other < Increase::Internal::Type::BaseModel
                # @!attribute country
                #   The two-character ISO 3166-1 code representing the country that issued the
                #   document.
              ...
              # @see Increase::EntityCreateParams::Trust::Trustee::Individual::Identification#passport
              class Passport < Increase::Internal::Type::BaseModel
                # @!attribute country
                #   The country that issued the passport.
                #
        ...
        # @see Increase::EntityCreateParams::Trust#grantor
        class Grantor < Increase::Internal::Type::BaseModel
          # @!attribute address
          #   The individual's physical address. Mail receiving locations like PO Boxes and
          #   PMB's are disallowed.
          #
          #   @return [Increase::EntityCreateParams::Trust::Grantor::Address]
          ...
          #   A means of verifying the person's identity.
          #
          #   @return [Increase::EntityCreateParams::Trust::Grantor::Identification]
          ...
          # @!method initialize(address:, date_of_birth:, identification:, name:, confirmed_no_us_tax_id: nil)
          #   Some parameter documentations has been truncated, see
          #   {Increase::EntityCreateParams::Trust::Grantor} for more details.
          #
          #   The grantor of the trust. Required if `category` is equal to `revocable`.
          #
          ...
          #   @param date_of_birth [Date] The person's date of birth in YYYY-MM-DD format.
          #
          #   @param identification [Increase::EntityCreateParams::Trust::Grantor::Identification] A means of verifying the person's identity.
          #
          #   @param name [String] The person's legal name.
          #
          #   @param confirmed_no_us_tax_id [Boolean] The identification method for an individual can only be a passport, driver's lic
          ...
          class Address < Increase::Internal::Type::BaseModel
            ...
            # @!method initialize(city:, line1:, state:, zip:, line2: nil)
            #   Some parameter documentations has been truncated, see
            #   {Increase::EntityCreateParams::Trust::Grantor::Address} for more details.
            #
            #   The individual's physical address. Mail receiving locations like PO Boxes and
            #   PMB's are disallowed.
            #
          ...
          # @see Increase::EntityCreateParams::Trust::Grantor#identification
          class Identification < Increase::Internal::Type::BaseModel
            # @!attribute method_
            #   A method that can be used to verify the individual's identity.
            #
            #   @return [Symbol, Increase::EntityCreateParams::Trust::Grantor::Identification::Method]
            required :method_,
            ...
            #   Required if `method` is equal to `drivers_license`.
            #
            #   @return [Increase::EntityCreateParams::Trust::Grantor::Identification::DriversLicense, nil]
            optional :drivers_license,
            ...
            #   equal to `other`.
            #
            #   @return [Increase::EntityCreateParams::Trust::Grantor::Identification::Other, nil]
            ...
            #   equal to `passport`.
            #
            #   @return [Increase::EntityCreateParams::Trust::Grantor::Identification::Passport, nil]
            optional :passport, -> { Increase::EntityCreateParams::Trust::Grantor::Identification::Passport }

            # @!method initialize(method_:, number:, drivers_license: nil, other: nil, passport: nil)
            #   Some parameter documentations has been truncated, see
            #   {Increase::EntityCreateParams::Trust::Grantor::Identification} for more details.
            #
            #   A means of verifying the person's identity.
            #
            ...
            # A method that can be used to verify the individual's identity.
            #
            # @see Increase::EntityCreateParams::Trust::Grantor::Identification#method_
            module Method
              extend Increase::Internal::Type::Enum
            ...
            # @see Increase::EntityCreateParams::Trust::Grantor::Identification#drivers_license
            class DriversLicense < Increase::Internal::Type::BaseModel
              # @!attribute expiration_date
              #   The driver's license's expiration date in YYYY-MM-DD format.
              #
            ...
            # @see Increase::EntityCreateParams::Trust::Grantor::Identification#other
            class Other < Increase::Internal::Type::BaseModel
              # @!attribute country
              #   The two-character ISO 3166-1 code representing the country that issued the
              #   document.
              ...
              # @!method initialize(country:, description:, file_id:, back_file_id: nil, expiration_date: nil)
              #   Some parameter documentations has been truncated, see
              #   {Increase::EntityCreateParams::Trust::Grantor::Identification::Other} for more
              #   details.
              #
              #   Information about the identification document provided. Required if `method` is
              #   equal to `other`.
            ...
            # @see Increase::EntityCreateParams::Trust::Grantor::Identification#passport
            class Passport < Increase::Internal::Type::BaseModel
              # @!attribute country
              #   The country that issued the passport.
              #
