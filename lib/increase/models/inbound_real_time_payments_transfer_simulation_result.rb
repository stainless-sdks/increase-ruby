    ...
    class InboundRealTimePaymentsTransferSimulationResult < BaseModel
      ...
      class DeclinedTransaction < BaseModel
        ...
        class Source < BaseModel
          ...
          #   @return [Increase::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CheckDepositRejection]
          required :check_deposit_rejection,
                   -> { Increase::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CheckDepositRejection }
