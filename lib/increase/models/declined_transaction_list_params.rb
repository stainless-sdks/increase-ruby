...
module Increase
  module Models
    ...
    class DeclinedTransactionListParams < Increase::Internal::Type::BaseModel
      ...
      #   #/paths//declined_transactions/get/parameters/2/schema
      #
      #   @return [String, nil]
      ...
      # @!attribute [r] cursor
      #   #/paths//declined_transactions/get/parameters/0/schema
      #
      #   @return [String, nil]
      ...
      # @!attribute [r] limit
      #   #/paths//declined_transactions/get/parameters/1/schema
      #
      #   @return [Integer, nil]
      ...
      #   #/paths//declined_transactions/get/parameters/7/schema
      #
      #   @return [String, nil]
      ...
      class Category < Increase::Internal::Type::BaseModel
        # @!attribute [r] in_
        #   #/paths//declined_transactions/get/parameters/8/schema
        #
        ...
        # #/paths//declined_transactions/get/parameters/8/schema/items
        module In
      ...
      class CreatedAt < Increase::Internal::Type::BaseModel
        # @!attribute [r] after
        #   #/paths//declined_transactions/get/parameters/3/schema
        #
        #   @return [Time, nil]
        optional :after, Time
        ...
        # @!attribute [r] before
        #   #/paths//declined_transactions/get/parameters/4/schema
        #
        #   @return [Time, nil]
        ...
        #   #/paths//declined_transactions/get/parameters/5/schema
        #
        #   @return [Time, nil]
        ...
        #   #/paths//declined_transactions/get/parameters/6/schema
        #
        #   @return [Time, nil]
