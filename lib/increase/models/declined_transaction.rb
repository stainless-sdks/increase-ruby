    ...
    class DeclinedTransaction < Increase::BaseModel
      ...
      class Source < Increase::BaseModel
        ...
        class ACHDecline < Increase::BaseModel
          ...
          #   #   @option data [String] :id The ACH Decline's identifier.
          #   #   @option data [Integer] :amount The declined amount in USD cents.
          #   #   @option data [String] :inbound_ach_transfer_id The identifier of the Inbound ACH Transfer object associated with this decline.
          ...
          #   #   @option data [String] :originator_company_id The identifier of the company that initiated the transfer.
          #   #   @option data [String] :originator_company_name The name of the company that initiated the transfer.
          #   #   @option data [String] :reason Why the ACH transfer was declined.
        ...
        class CardDecline < Increase::BaseModel
          ...
          class NetworkDetails < Increase::BaseModel
            ...
            class Visa < Increase::BaseModel
              ...
              #   @return [Symbol, Increase::Models::DeclinedTransaction::Source::CardDecline::NetworkDetails::Visa::StandInProcessingReason]
        ...
        class CheckDecline < Increase::BaseModel
          ...
          #   # @param data [Hash{Symbol => Object}] .
          #   #   @option data [Integer] :amount The declined amount in USD cents.
          #   #   @option data [String] :auxiliary_on_us A computer-readable number printed on the MICR line of business checks, usually
          ...
          #   #     declined check.
          #   #   @option data [String] :check_transfer_id The identifier of the Check Transfer object associated with this decline.
          #   #   @option data [String] :front_image_file_id The identifier of the API File object containing an image of the front of the
          #   #     declined check.
          #   #   @option data [String] :inbound_check_deposit_id The identifier of the Inbound Check Deposit object associated with this decline.
          #   #   @option data [String] :reason Why the check was declined.
          #   def initialize(data = {}) = super
        end
        ...
        class WireDecline < Increase::BaseModel
          ...
          #   #
          #   # @param data [Hash{Symbol => Object}] .
          #   #   @option data [String] :inbound_wire_transfer_id The identifier of the Inbound Wire Transfer that was declined.
          #   #   @option data [String] :reason Why the wire transfer was declined.
          #   def initialize(data = {}) = super
        end
        ...
        #   #
        #   # @param data [Hash{Symbol => Object}] .
        #   #   @option data [Object] :ach_decline An ACH Decline object. This field will be present in the JSON response if and
        ...
        #   #   @option data [Object] :check_decline A Check Decline object. This field will be present in the JSON response if and
        #   #     only if `category` is equal to `check_decline`.
        #   #   @option data [Object] :check_deposit_rejection A Check Deposit Rejection object. This field will be present in the JSON
        ...
        #   #   @option data [Object] :wire_decline A Wire Decline object. This field will be present in the JSON response if and
      ...
      #   #
      #   # @param data [Hash{Symbol => Object}] .
      #   #   @option data [String] :id The Declined Transaction identifier.
      #   #   @option data [String] :account_id The identifier for the Account the Declined Transaction belongs to.
      #   #   @option data [Integer] :amount The Declined Transaction amount in the minor unit of its currency. For dollars,
      #   #     for example, this is cents.
      #   #   @option data [String] :created_at The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date on which the
      #   #     Transaction occurred.
      #   #   @option data [String] :currency The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the Declined
      #   #     Transaction's currency. This will match the currency on the Declined
      #   #     Transaction's Account.
      #   #   @option data [String] :description This is the description the vendor provides.
      #   #   @option data [String] :route_id The identifier for the route this Declined Transaction came through. Routes are
      #   #     things like cards and ACH details.
      #   #   @option data [String] :route_type The type of the route this Declined Transaction came through.
