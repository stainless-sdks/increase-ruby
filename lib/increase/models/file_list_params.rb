  ...
  module Models
    ...
    class FileListParams < Increase::Internal::Type::BaseModel
      ...
      class CreatedAt < Increase::Internal::Type::BaseModel
        # @!attribute [r] after
        #   #/paths//files/get/parameters/2/schema
        #
        #   @return [Time, nil]
        optional :after, Time
        ...
        # @!attribute [r] before
        #   #/paths//files/get/parameters/3/schema
        #
        #   @return [Time, nil]
        ...
        #   #/paths//files/get/parameters/4/schema
        #
        #   @return [Time, nil]
        ...
        #   #/paths//files/get/parameters/5/schema
        #
        #   @return [Time, nil]
      ...
      class Purpose < Increase::Internal::Type::BaseModel
        # @!attribute [r] in_
        #   #/paths//files/get/parameters/6/schema
        #
        ...
        # #/paths//files/get/parameters/6/schema/items
        module In
