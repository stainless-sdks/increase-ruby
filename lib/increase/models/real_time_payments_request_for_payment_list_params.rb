...
module Increase
  module Models
    class RealTimePaymentsRequestForPaymentListParams < Increase::BaseModel
      ...
      #
      #   @return [Increase::Models::RealTimePaymentsRequestForPaymentListParams::CreatedAt, nil]
      optional :created_at, -> { Increase::Models::RealTimePaymentsRequestForPaymentListParams::CreatedAt }

      # @!parse
      #   # @return [Increase::Models::RealTimePaymentsRequestForPaymentListParams::CreatedAt]
      ...
      # @!parse
      #   # @param account_id [String] Filter Real-Time Payments Request for Payments to those destined to the
      #   #   specified Account.
      #   #
      #   # @param created_at [Increase::Models::RealTimePaymentsRequestForPaymentListParams::CreatedAt]
      #   #
