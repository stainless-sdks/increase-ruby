...
module Increase
  module Models
    class File < Increase::BaseModel
      ...
      #   #   @option data [String] :id The File's identifier.
      #   #   @option data [String] :created_at The time the File was created.
      #   #   @option data [String] :description A description of the File.
      #   #   @option data [String] :direction Whether the File was generated by Increase or by you and sent to Increase.
      #   #   @option data [String] :download_url A URL from where the File can be downloaded at this point in time. The location
      #   #     of this URL may change over time.
      #   #   @option data [String] :filename The filename that was provided upon upload or generated by Increase.
      ...
      #   #   @option data [String] :mime_type The MIME type of the file.
      #   #   @option data [String] :purpose What the File will be used for. We may add additional possible values for this
