...
module Increase
  module Models
    ...
    class File < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Increase::File::Direction]
      ...
      #   gracefully.
      #
      #   @return [Symbol, Increase::File::Purpose]
      ...
      #   `file`.
      #
      #   @return [Symbol, Increase::File::Type]
      ...
      #   Some parameter documentations has been truncated, see {Increase::File} for more
      #   details.
      #
      ...
      #
      #   @param direction [Symbol, Increase::File::Direction] Whether the File was generated by Increase or by you and sent to Increase.
      #
      ...
      #
      #   @param purpose [Symbol, Increase::File::Purpose] What the File will be used for. We may add additional possible values for this e
      #
      #   @param type [Symbol, Increase::File::Type] A constant representing the object's type. For this resource it will always be `

      # Whether the File was generated by Increase or by you and sent to Increase.
      #
      # @see Increase::File#direction
      module Direction
