...
module Increase
  module Models
    ...
    #   created_at: Time,
    #   description: String,
    #   direction: enum: Increase::Models::File::Direction,
    #   download_url: String,
    #   **_
    # }
    # ```
    class File < Increase::BaseModel
      ...
      #   #
      #   # @param download_url [String, nil] A URL from where the File can be downloaded at this point in time. The location
