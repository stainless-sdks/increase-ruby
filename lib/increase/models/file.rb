...
module Increase
  module Models
    class File < BaseModel
      ...
      #   One of the constants defined in {Increase::Models::File::Direction}
      #   @return [Symbol]
      ...
      #   One of the constants defined in {Increase::Models::File::Purpose}
      #   @return [Symbol]
      ...
      #   One of the constants defined in {Increase::Models::File::Type}
      #   @return [Symbol]
