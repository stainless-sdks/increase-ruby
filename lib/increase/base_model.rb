  ...
  class ArrayOf
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { |item| Increase::Converter.coerce(type, item) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { |item| Increase::Converter.dump(type, item) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case Increase::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class HashOf
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Increase::Converter.coerce(type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          Increase::Converter.dump(type, val)
        end
      else
        value
      end
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case Increase::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class BaseModel
    ...
    private_class_method def self.add_field(name_sym, required:, type_info:, spec:)
      ...
      define_method(name_sym) do
        ...
        Increase::Converter.coerce(field_type, value)
      ...
      values = coerced.filter_map do |key, val|
        ...
        in nil
          ...
          in :coerce
            ...
            target = type_fn.call
            [api_name, Increase::Converter.dump(target, val)]
          end
        end
      end.to_h
    ...
    def self.try_strict_coerce(value)
      ...
      known_fields.each_value do |field|
        ...
        in [_, true]
          ...
          case Increase::Converter.try_strict_coerce(target, item)
          in [true, coerced, score]
            tally += score
