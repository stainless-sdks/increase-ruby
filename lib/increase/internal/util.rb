  ...
  module Internal
    ...
    module Util
      ...
      module SorbetRuntimeSupport
        ...
        protected def sorbet_runtime_constants = @sorbet_runtime_constants ||= {}
        ...
        # @param name [Symbol]
        # @param blk [Proc]
        private def define_sorbet_constant!(name, &blk) = sorbet_runtime_constants.store(name, blk)
      end

      extend Increase::Internal::Util::SorbetRuntimeSupport

      define_sorbet_constant!(:ParsedUriShape) do
        T.type_alias do
          {
