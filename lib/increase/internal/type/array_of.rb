  ...
  module Internal
    module Type
      ...
      class ArrayOf
          ...
          value
            .map do |item|
              ...
              in [true, nil]
                ...
                Increase::Internal::Type::Converter.coerce(target, item, state: state)
              end
            end
        end
        ...
        def inspect(depth: 0)
          # rubocop:disable Layout/LineLength
          "#{self.class}[#{[Increase::Internal::Type::Converter.inspect(item_type, depth: depth.succ), nilable? ? 'nil' : nil].compact.join(' | ')}]"
          # rubocop:enable Layout/LineLength
        end
      end
    end
