  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, Increase::Internal::Type::Converter, Class]
        #
        ...
        # @param value [Object]
        #
        # @return [Increase::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          ...
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, Increase::Internal::Util::OMIT)
            end

            return nil if key == Increase::Internal::Util::OMIT
        ...
        def dump(value)
          if (target = resolve_variant(value))
            return Increase::Internal::Type::Converter.dump(target, value)
          end

          known_variants.each do
            target = _2.call
            return Increase::Internal::Type::Converter.dump(target, value) if target === value
          end
